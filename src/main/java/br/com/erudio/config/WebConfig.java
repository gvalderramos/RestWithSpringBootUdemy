...
public class WebConfig implements WebMvcConfigurer {
	...
	public void configureContentNegotiation(ContentNegotiationConfigurer configurer) {
		...
		/*
		 * VIA EXTENSION = http://localhost/api/person/v1.json || http://localhost/api/person/v1.xml
		...
		*/
		...
		/* VIA QUERY PARAM = http://localhost/api/person/v1?mediaType=json || http://localhost/api/person/v1?mediaType=xml
